...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    Resources: ["How It Works", "Sample Report", "Research"],
  };
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="md:col-span-1">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-2xl font-bold">HelloMRI™</span>
              </div>
              <p className="text-sm text-muted-foreground mb-4">
                Your brain, beautifully mapped.
              </p>
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 rounded-full bg-white/50 border border-white/20 flex items-center justify-center hover:bg-white/80 transition-colors">
          ...
          <div className="pt-8 border-t border-border/50 text-center">
            <p className="text-sm text-muted-foreground">
              © {currentYear} HelloMRI Inc. All rights reserved.
            </p>
          </div>
        </div>
      </div>
